...
panjang_tubuh = st.sidebar.number_input(
    "Panjang Tubuh ", min_value=0.0, value=39.1, step=0.1
)
lebar_tubuh = st.sidebar.number_input(
    "Lebar Tubuh ", min_value=0.0, value=18.7, step=0.1
)
panjang_sirip = st.sidebar.number_input(
    "Panjang Sirip ", min_value=0, value=181, step=1
)
